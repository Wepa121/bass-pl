...
export const arr = [
  ...
  {
    name:"Fuse",
    explanation:`Fuse is a friend of the circuit breaker as it helps the breaker in protecting the electric equipment from power overload. Fuse is the wire that gets heated up and damaged when the circuit comes in contact with a power surge. In this way, the current stops flowing.`,
  },
  {
    name:"Switch",
    explanation:`Yes! We all know what a switch is! Let's get to its technical definition. The primary purposes of a switch as a device are to break the current, interrupt the current, and supply current from one conductor to another. The “On and off” mechanism is used to perform this task. There are 4 main classifications of a switch`,
  },
  {
    name:"Transformer",
  ...
  {
    name:"Battery",
    explanation:`Batteries act as a source of electric power through the electrochemical cells. Each cell is consists of an anode (-), cathode (+), and electrolyte. It works on the principle of electrochemical reaction as the cells create the flow of electrons through a chemical reaction. In layman's terms, batteries are portable containers that store electrical potential energy.`,
  },
  {
    name:"Relay",
    explanation:`Earlier relays were used as amplifiers in the long-distance telegraph circuits. Relay evolved to solve more purposes in the technology sector and telephone exchange. They are electromechanical switches that use low-power signals to control the circuit.`,
  },
  {
    name:"Motor",
    explanation:`Motors convert electrical energy into mechanical energy. It comprises a stator, conduit box, eye bolt, rotor, enclosure, and bearings. Motors are more efficient in energy supply than their pneumatic and hydraulic counterparts. Therefore it is the most common part amongst all the electrical machinery.`,
  }
]